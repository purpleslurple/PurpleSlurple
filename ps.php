...
if (isset($_SERVER['HTTP_X_FORWARDED_HOST']) && ($_SERVER['HTTP_X_FORWARDED_HOST'] !="") ) {
    $file_url = $_SERVER['HTTP_X_FORWARDED_PROTO'] . "://" . $_SERVER['HTTP_X_FORWARDED_HOST'] . $_SERVER['HTTP_X_ORIGINAL_URI'];
}
...
'?theurl=https://web.archive.org/web/20020705201817/http://www.treelight.com/software/collaboration/whatsWrongWithEmail.html#PS83">granular addressability</a>. <em>(Note that this link points to PurpleSlurple number 83, the section regarding Granular Addressability.)</em></p>
...
foreach ($elements as $element) {
    ...
    $aElement->setAttribute('href', "$file_url?theurl=$theurl#$fragmentId");
